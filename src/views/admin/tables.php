...
<body class="font-poppins bg-gray-50 text-gray-900 leading-relaxed overflow-x-hidden">
        ...
        <nav class="flex-1 py-4">
            <ul class="space-y-1 px-4">
                ...
                <li>
                    ...
                    <a href="<?php echo htmlspecialchars(BASE_PATH . '/admin/tables', ENT_QUOTES, 'UTF-8'); ?>" class="flex items-center space-x-3 p-3 rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-900 border-l-4 border-blue-600 shadow-sm relative overflow-hidden">
                        ...
                        <span class="font-medium">Data Tables</span>
                ...
                <li>
                    <a href="<?php echo htmlspecialchars(BASE_PATH . '/admin/reports', ENT_QUOTES, 'UTF-8'); ?>" class="flex items-center space-x-3 p-3 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors duration-200 relative overflow-hidden group">
                        <div class="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-indigo-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
    ...
    <div class="ml-64 transition-all duration-300" id="container">
        <!-- Enhanced Dashboard Header -->
                <div class="bg-gradient-to-br from-green-900 to-blue-500 p-8 rounded-b-xl shadow-2xl flex items-center justify-between mb-10 text-white relative overflow-hidden">            <div class="flex items-center space-x-4 z-10">
                ...
                <div class="relative">
                    <div class="bg-gradient-to-br from-green-500 to-blue-600 rounded-full w-12 h-12 flex items-center justify-center shadow-lg">
                ...
                <div>
                    ...
                    <p class="text-green-100 mt-1">Manage internal company data and records</p>
                </div>
            </div>
        ...
        <div class="px-8 mb-8">
            <div class="bg-white p-6 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl flex items-center space-x-4 max-w-md">
                <div class="bg-gradient-to-br from-green-900 to-blue-500 w-12 h-12 rounded-lg flex items-center justify-center text-white">
    ...
    <?php if (empty($data['operationalCards'])): ?>
        <div class="col-span-full bg-white rounded-2xl shadow-lg border border-gray-100 p-8 text-center">
            <div class="bg-gradient-to-br from-green-100 to-blue-100 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6">
                <i class="fas fa-table text-3xl text-green-600"></i>
            </div>
            <h3 class="text-2xl font-bold text-gray-900 mb-3">No Data Tables Available</h3>
            <p class="text-gray-600 mb-8 max-w-md mx-auto">Create your first data table to start managing company information and organizing your business data.</p>
            <button class="bg-gradient-to-br from-green-600 to-blue-700 text-white px-6 py-3 rounded-xl font-semibold cursor-pointer transition-all duration-300 flex items-center gap-3 mx-auto hover:shadow-lg hover:-translate-y-1">
                <i class="fas fa-plus"></i> Create Your First Table
            </button>
        </div>
    <?php else: ?>
        <?php foreach ($data['operationalCards'] as $card): ?>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <a href="<?php echo htmlspecialchars(BASE_PATH . $card['link'], ENT_QUOTES, 'UTF-8'); ?>" class="block h-full flex flex-col">
                    <!-- Card header with gradient background -->
                    <div class="bg-gradient-to-r from-green-500 to-blue-600 p-4 flex items-center justify-between relative">
                    ...
                    <div class="p-5 flex-grow flex flex-col">
                        <div class="flex items-center mb-2">
                            <!-- Smaller custom design in front of the table name -->
                            <div class="relative inline-block mr-3">
                                <div class="bg-gradient-to-br from-green-500 to-blue-600 rounded-2xl w-20 h-20 flex items-center justify-center shadow-xl">
                                ...
                                <div class="absolute -bottom-2 -left-2 bg-green-500 rounded-full w-8 h-8 flex items-center justify-center shadow-md">
                        ...
                        <!-- Animated button -->
                        <div class="mt-auto">
                            <div class="inline-flex items-center text-green-600 text-sm font-semibold group">
                                View Table
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-5 py-3 text-xs text-gray-500 flex items-center">
                        ...
                        <span>Click to manage data</span>
                    </div>
                </a>
            </div>
        <?php endforeach; ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Set initial active state for tables
            const tablesLink = document.querySelector('.sidebar a[href="<?php echo htmlspecialchars(BASE_PATH . '/admin/tables', ENT_QUOTES, 'UTF-8'); ?>"]');
            if (tablesLink) {
                tablesLink.classList.remove('text-gray-700', 'hover:bg-gray-100');
                tablesLink.classList.add('bg-gradient-to-r', 'from-blue-50', 'to-indigo-50', 'text-blue-900', 'border-l-4', 'border-blue-600', 'shadow-sm');
                
                // Add custom design element for active state if not present
                if (!tablesLink.querySelector('.absolute.right-2')) {
                    const indicator = document.createElement('div');
                    indicator.className = 'absolute right-2 top-1/2 transform -translate-y-1/2 w-2 h-2 rounded-full bg-blue-500';
                    tablesLink.appendChild(indicator);
                }
            }
        });
    </script>
