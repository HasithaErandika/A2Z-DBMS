        ...
        <div>
            ...
            <main class="p-8">
                ...
                <div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-12 text-center max-w-2xl mx-auto">
                    ...
                    <h3 class="text-xl font-bold text-slate-900 mb-2">Material Cost Calculation</h3>
                    <p class="text-sm text-slate-500 mb-6 leading-relaxed">
                        This module is currently in development. Once connected, it will provide detailed estimates, resource consumption tracking, and material cost insights.
                    </p>
                    ...
                    <div class="bg-slate-50 border border-slate-100 rounded-xl p-6 text-left space-y-3.5 max-w-md mx-auto">
                        ...
                        <ul class="text-xs text-slate-650 space-y-2.5">
                            <li class="flex items-center gap-2">
                                <i class="fas fa-check-circle text-emerald-500"></i> Material cost breakdown by project and task
                            </li>
                            <li class="flex items-center gap-2">
                                <i class="fas fa-check-circle text-emerald-500"></i> Category-wise resource expenditure filtering
                            </li>
                            <li class="flex items-center gap-2">
                                <i class="fas fa-check-circle text-emerald-500"></i> Material cost vs labor cost comparison analytics
                            </li>
                            <li class="flex items-center gap-2">
                                <i class="fas fa-check-circle text-emerald-500"></i> CSV/PDF report extraction features
                            </li>
                        </ul>
                    </div>
                </div>
